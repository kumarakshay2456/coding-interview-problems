...
if __name__ == "__main__":
    ...
    RotateMatrix().rotate_matrix([[5,1,9,11,1],[2,4,8,10,2],[13,3,6,7,3],[15,14,12,16,4], [18,12,12,16,18]])
    RotateMatrix().rotate_matrix([[5,1,9,11,1],[2,4,8,10,2],[13,3,6,7,3],[15,14,12,16,4], [18,12,12,16,18]])
    RotateMatrix().rotate_matrix([[5,1,9,11,1,7],[2,4,8,10,2,1],[13,3,6,7,3,7],[15,14,12,16,4,9], [18,12,12,16,18,12]])